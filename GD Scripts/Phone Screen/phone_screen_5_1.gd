...
# Let's grab BOTH button nodes just to be safe!
...
var chat_messages = [
	{"sender": "Kylie", "text": "Guys, need na natin mag-start ng proposal ASAP."},
	{"sender": "Groupmate 2", "text": "May deadline na next week."}
]
